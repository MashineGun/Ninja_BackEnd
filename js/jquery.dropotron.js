			...
			_menus.find('a')
				...
				.click(function(e) {
					...
					if (jQuery(this).attr('href').length < 1)
						e.preventDefault();
						//CK Added
						jQuery(this).closest('.dropdown').find('.label').html(jQuery(this).html());
						jQuery(this).closest('.dropdown').find('.label').attr('value', jQuery(this).attr('value'));
						if ((typeof jQuery(this).attr('data-goal') !== 'undefined') && (jQuery(this).attr('data-goal') != '')) {
							jQuery(this).closest('.dropdown').find('.label').attr('data-goal', jQuery(this).attr('data-goal'));
						}
						else {
							jQuery(this).closest('.dropdown').find('.label').attr('data-goal', '');
						}
				});
